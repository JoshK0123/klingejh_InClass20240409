<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="klingejh_InClass20240409._default" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:ListBox ID="lbFruits" runat="server" CssClass="ListBoxCssClass" Height="157px" AutoPostBack="True" OnSelectedIndexChanged="lbFruits_SelectedIndexChanged" DataSourceID="sqlDataSourceInClass20240409" DataTextField="LastName" DataValueField="NameID">
